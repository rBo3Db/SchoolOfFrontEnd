define(['tpl!index.html'], function(tpl) {
	console.log(-1);
	return function(sel)
	{
		console.log(0);
		//$.get( "index.html", function(строка_щаблона) {
	 	...
	 	$(sel).html(tpl([{name: 'Стул', единица_измерения: 'шт', количество: '2', цена_за_единицу: '25000', цена_за_всё: '50000', акциз: '0,00', сумма_налога: '9000',
	 	стоимость_всего_с_учетом_налога: '56000',страна: 'Испания, Италия', номер_тд: '14, 32'},
	 	{name: 'Стул', единица_измерения: 'шт', количество: '2', цена_за_единицу: '25000', цена_за_всё: '50000', акциз: '0,00', сумма_налога: '9000',
	 	стоимость_всего_с_учетом_налога: '56000',страна: 'Испания, Италия', номер_тд: '14, 32'},
	 	{name: 'Стул', единица_измерения: 'шт', количество: '2', цена_за_единицу: '25000', цена_за_всё: '50000', акциз: '0,00', сумма_налога: '9000',
	 	стоимость_всего_с_учетом_налога: '56000',страна: 'Испания, Италия', номер_тд: '14, 32'}
	 	]));
